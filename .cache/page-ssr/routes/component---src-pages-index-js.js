...
/* harmony export */ });
/* harmony import */ var _react_wavify_module_dev_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./react-wavify.module.dev.js */ "./node_modules/react-wavify/lib/react-wavify.module.dev.js");
'use client'

;


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ( false ? 0 : _react_wavify_module_dev_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
/* harmony import */ var react_wavify__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-wavify */ "./node_modules/react-wavify/lib/index.module.js");
...
const IndexPage = () => {
  ...
  const aboutContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "text-2xl font-bold text-[#222] dark:text-white"
    ...
    className: "text-lg font-semibold text-[#222] dark:text-gray-200"
  ...
  const workContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "text-lg font-semibold text-[#222] dark:text-white"
  ...
  const contactContent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "text-[#222] dark:text-gray-300"
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "flex-1 flex flex-col justify-center bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 relative overflow-hidden"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "absolute bottom-0 left-0 right-0 h-1/2"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_wavify__WEBPACK_IMPORTED_MODULE_5__["default"], {
    fill: "#3b82f6",
    paused: false,
    options: {
      height: 20,
    ...
    className: "fixed top-0 left-0 right-0 h-16 bg-gray-50 dark:bg-gray-900 z-50"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "w-full px-4 h-full flex items-center justify-start max-w-none mx-0"
    ...
    className: "bg-white dark:bg-gray-800 rounded-lg shadow-lg w-96 border-2 border-gray-300 dark:border-gray-600"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "bg-blue-600 p-2 rounded-t-lg"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "text-white font-bold text-base text-left"
  }, "home")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "px-4 pt-4 text-center"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", {
    className: "text-2xl font-semibold text-gray-800 dark:text-white"
  }, "hi! ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "text-blue-600"
  }, "i'm ari")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "text-gray-600 dark:text-gray-300"
  }, "website developer, data analyst, finance")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "p-6 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-full w-full sm:w-96 md:w-[40rem] mx-auto"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ref: aboutRef,
    ...
    alt: "Contact Logo",
    className: "w-full h-full object-contain"
  })))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, activePopups.links && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ContentPopup__WEBPACK_IMPORTED_MODULE_2__["default"], {
    title: "links",
